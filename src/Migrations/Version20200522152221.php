 ...
 */
final class Version20200522152221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE navigations (id INT AUTO_INCREMENT NOT NULL, svg_id INT NOT NULL, eid VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, position INT NOT NULL, sub_position INT DEFAULT NULL, authorisation VARCHAR(10) NOT NULL, translation VARCHAR(255) NOT NULL, INDEX IDX_AD21D8F37517183B (svg_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, subject_id INT NOT NULL, user_id INT DEFAULT NULL, eid VARCHAR(255) NOT NULL, choice INT NOT NULL, notation INT DEFAULT 0 NOT NULL, INDEX IDX_136AC11323EDC87 (subject_id), INDEX IDX_136AC113A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
