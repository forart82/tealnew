 ...
 */
final class Version20200502162359 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE navigations (id INT AUTO_INCREMENT NOT NULL, svg_id INT NOT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, position INT NOT NULL, sub_position INT DEFAULT NULL, authorisation VARCHAR(10) NOT NULL, translation VARCHAR(255) NOT NULL, INDEX IDX_AD21D8F37517183B (svg_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subject (id INT AUTO_INCREMENT NOT NULL, svg_id INT DEFAULT NULL, question LONGTEXT NOT NULL, answer_one LONGTEXT NOT NULL, answer_two LONGTEXT NOT NULL, answer_three LONGTEXT NOT NULL, answer_four LONGTEXT NOT NULL, answer_five LONGTEXT NOT NULL, position INT NOT NULL, user_notation INT NOT NULL, title VARCHAR(255) NOT NULL, is_respond TINYINT(1) DEFAULT \'0\' NOT NULL, language VARCHAR(255) NOT NULL, INDEX IDX_FBCE3E7A7517183B (svg_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE subject ADD CONSTRAINT FK_FBCE3E7A7517183B FOREIGN KEY (svg_id) REFERENCES svg (id) ON DELETE SET NULL');
